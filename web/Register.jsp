                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" id="DelAdd" type="text" placeholder="Delivery Address (House No./Unit No. Street, City, Country)" data-error="Please input a valid email." required>                                                       
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" id="BillAdd" type="text" placeholder="Billing Address (House No./Unit No. Street, City, Country)" data-error="Please input a valid email." required>                                                       
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
